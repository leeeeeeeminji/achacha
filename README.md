...
## 💬 소감
적극적인 팀원들과 함께 하며 이번 프로젝트로 진정한 협업에 대해 배울 수 있었다. <br>
프로젝트를 진행하며 생긴 모든 이슈들을 직접 발로 뛰며 함께 해결하고 매일 모여 토론하는 과정을 거치면서 매 순간 성장하고 있다는 것을 느꼈다.<br>
파이썬 코드와 웹 코드를 연결하지 못한 부분은 아쉽지만, 이번 팀 프로젝트를 하며 서비스 구현만큼 팀원들의 협업이 중요하다는 것을 느꼈다.
